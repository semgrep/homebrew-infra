class KeyringWithCodeartifact < Formula
  ...
  resource "keyrings.codeartifact" do
    url "https://files.pythonhosted.org/packages/8d/55/2941103eb3827f0952863ad847d76b467c5cd2c95ce7795d6cf22e9fa37c/keyrings_codeartifact-2.1.2.tar.gz"
  ...
  test do
    ...
    assert_match "keyrings.codeartifact.CodeArtifactBackend", shell_output("#{bin}/keyring --list-backends")
  end
end